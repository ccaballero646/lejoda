...
public class ListarProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List productoList = pManager.listarProductos(con);
        request.setAttribute("lista", productoList);
        logger.info("Listado de productos exitoso");
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/producto/listar.jsp");
