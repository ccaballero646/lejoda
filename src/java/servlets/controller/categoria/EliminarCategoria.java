 ...
 * @author Cristhian
 */
@WebServlet(name = "EliminarCategoria", urlPatterns = {"/categoria/eliminar"})
public class EliminarCategoria extends HttpServlet {
    static Logger logger = Logger.getLogger(EliminarCategoria.class);
