<%-- 
    Document   : editar
    Created on : oct 18, 2014, 11:12:25 a.m.
    Author     : Cristhian
--%>
...
<body>
    ...
    <section id="contenido">
        ...
        <div class="col-md-8">
            Editar la Categoria ${descripcion}
            <form action="/paronline/categoria/editar" method="POST">
                <table>
                <tr>
                    <td>
            ...
            <a href="/paronline/categoria/eliminar?id=${id}">Eliminar esta categoria</a>
         </div>
