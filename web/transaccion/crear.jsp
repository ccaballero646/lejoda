...
<body>
    ...
    <section id="contenido">
        ...
        <div class="col-md-8">
            Confirmar Compra
            <form action="/paronline/transaccion/crear" method="POST">
                <table>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="total" value="${requestScope.total}" readonly="readonly">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Numero de Tarjeta de Credito</strong>:
                    </td>
                    <td>
