...
<body>
    ...
    <nav>
        <ul>
            ...
            <%}%>
            <li><a id="link" href='carrito/listar'>Carrito</a></li>
        ...
        <form action="Register" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="login_name" value="${sessionScope.usuario.loginName}" readonly="readonly">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Repetir nuevo Password</strong>:
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="tipo_usuario" size="1" readonly="readonly">
